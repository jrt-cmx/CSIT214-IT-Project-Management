            ...
            if ($numOfRows > 0)
            {
              while ($row = mysqli_fetch_assoc($result))
              {
                ...
                if($row['approved'] == "false")
                {
                    ...
                    echo '<td><a href="approveRoom.php?roomID='.$row['roomID'].'"><input type="button" value="Approve" style="width: 80px"></a></td>';
                    echo '<td><a href="rejectRoom.php?roomID='.$row['roomID'].'"><input type="button" value="Reject" style="width: 80px"></a></td>';
                }
